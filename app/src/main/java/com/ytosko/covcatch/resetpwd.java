                            ...
                            .addOnCompleteListener(new OnCompleteListener<Void>() {
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        pDialog.dismiss();
                                        Toast.makeText(resetpwd.this, "Password reset link sent successfully to " + xm, Toast.LENGTH_SHORT).show();
                                        ...
                                        pDialog.dismiss();
                                        Toast.makeText(resetpwd.this, task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                                    }
                                }
                            });
                }
