package com.ytosko.covcatch.adapters;
...
import com.ytosko.covcatch.R;
import com.ytosko.covcatch.models.BlePeripheralListItem;
...
public class BlePeripheralsListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (mBluetoothPeripheralListItems.size() <= 0) {
            ...
            String uid = item.getBroadcastName();

            peripheralListItemView.mBroadcastNameTV.setText(uid);
